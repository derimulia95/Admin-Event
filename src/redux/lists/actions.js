...
export const fetchListCategories = () => {
  return async (dispatch) => {
    ...
    try {
      let res = await debouncedFetchListsCategories("api/v1/category");
...
export const fetchListSpeakers = () => {
  return async (dispatch) => {
    ...
    try {
      let res = await debouncedFetchListsSpeakers("api/v1/speaker");
...
export const fetchListEvents = () => {
  return async (dispatch) => {
    ...
    try {
      let res = await debouncedFetchListsEvents("api/v1/event");
